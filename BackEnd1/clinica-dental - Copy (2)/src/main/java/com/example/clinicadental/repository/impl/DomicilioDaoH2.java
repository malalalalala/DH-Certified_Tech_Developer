...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    public Domicilio guardar(Domicilio domicilio) {
        ...
        try {
            ...
            preparedStatement = configuracion.conectarConBaseDeDatos() .prepareStatement("INSERT INTO domicilios(calle,numero,localidad,provincia) VALUES(?,?,?,?)",Statement.RETURN_GENERATED_KEYS);
    ...
    public void eliminar(Integer id) {
        ...
        try {
            ...
            preparedStatement = configuracion.conectarConBaseDeDatos() .prepareStatement("DELETE FROM domicilios where id = ?");
    ...
    public Domicilio buscar(Integer id) {
       ...
       ;
            ...
            //2 Crear una sentencia
            preparedStatement = configuracion.conectarConBaseDeDatos() .prepareStatement("SELECT id,calle,numero,localidad,provincia FROM domicilios where id = ?");
            preparedStatement.setInt(1,id);
    ...
    public List<Domicilio> buscarTodos() {
        ...
        try {
            ...
            //2 Crear una sentencia
            preparedStatement = configuracion.conectarConBaseDeDatos() .prepareStatement("SELECT *  FROM domicilios");
    ...
    public Domicilio actualizar(Domicilio domicilio) {
        ...
        try {
             ...
             preparedStatement = configuracion.conectarConBaseDeDatos() .prepareStatement("UPDATE domicilios SET calle = ?, numero = ? ,localidad = ?, provincia = ?  WHERE id = ?");
            //No le vamos a pasar el ID ya que hicimos que fuera autoincremental en la base de datos
            //preparedStatement.setInt(1,domicilio.getId());
            preparedStatement.setString(1, domicilio.getCalle());
            preparedStatement.setString(2, domicilio.getNumero());
