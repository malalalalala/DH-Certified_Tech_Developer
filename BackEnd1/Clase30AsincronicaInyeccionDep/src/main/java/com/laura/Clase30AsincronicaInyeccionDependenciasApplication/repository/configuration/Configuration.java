package com.laura.Clase30AsincronicaInyeccionDependenciasApplication.repository.configuration;
...
public class Configuration {
    ...
    public Configuration() {
        ...
        this.dbUrl = "jdbc:h2:~/db_inyeccion;INIT=RUNSCRIPT FROM 'create.sql'";
