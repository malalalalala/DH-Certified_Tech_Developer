...
// programación, tanto que hay toda un área en función de ellos. Para entender un poco
// más sobre por qué son tan útiles e importantes, vamos a realizar una serie de
// prácticas para afianzar mejor las particularidades y utilidades que vienen con ellos.
// Para esta actividad, recordá que podés verificar cada punto ejecutando los métodos y
// las operaciones que realices para asegurarte de que todo funcione correctamente.
...
const banco = {
  ...
  consultarCliente(titular) {
    for (let i = 0; i < this.clientes.length; i++) {
      const cuenta = this.clientes[i]
      // console.log(`cuenta en la posicion ${i}`, cuenta)
  ...
  deposito(titular, dinero) {
    ...
    console.log("cuetibitir", cuenta)
    cuenta.saldoEnPesos += dinero
    console.log(
...
console.log("banco.consultarCliente()", banco.consultarCliente("Ramon Connell"))
